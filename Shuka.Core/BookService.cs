...
public class BookService
{
    ...
    public static readonly ISiteAdapter[] Adapters =
        [new ShukuAdapter(), new CzBooksAdapter(), new DmxsAdapter(), new ShubaAdapter(), new QuanbenAdapter(), new SituuAdapter()];
    ...
    private static ISiteAdapter DetectAdapter(string url) =>
        ...
        ?? throw new Exception($"No supported adapter for URL: {url}\nSupported: 52shuku.net, czbooks.net, dmxs.org, 69shuba.com, quanben.io, situu.cc");
